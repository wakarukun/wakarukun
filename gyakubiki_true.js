function gyakubiki_true(flag) {
    ...
    switch (O_value) {
        ...
        case "hikari":
            ...
            fusionname = ["メビウスフェニックスブレイブ", "ナイトリキデイター", "ナイトリキデイター", "ブレスターナイト", "ビクトリーナイト"];
        ...
        case "ginga":
            ...
            fusioncolor = ["cc00cc", "286f2c", "666666", "0000cc", "0000cc"];
        ...
        case "victory":
            ...
            fusioncolor = ["dd830c", "286f2c", "666666", "0000cc", "0000cc"];
        ...
        case "x":
            ...
            fusioncolor = ["2196f3", "cc00cc", "2196f3", "0000cc", "0000cc"];
        ...
        if (T_value2 == "個別に選ぶ？") {
            for (p = 0; p < card[a].length; p++) {
                for (q = 0; q < card[b[b_num]].length; q++) {
                    var sum = 0;
                    for (j = 1; j < 5; j++) {
                      number = Math.max(card[a][p][j], card[b[b_num]][q][j]) * Kcard[a][j - 1];
