function Calc() {
  ...
  document.ans.panch_min.value = Math.round(ko_tr * 18 * ra_sk1 * ra_sk2 * 0.95);
  document.ans.panch_max.value = Math.round(ko_tr * 18 * ra_sk1 * ra_sk2 * 47 / 45);
  document.ans.kikku.value = Math.round((ko_tr * 10 + ha_tr * 8) * ra_sk1 * ra_sk2);
  document.ans.kikku_min.value = Math.round((ko_tr * 10 + ha_tr * 8 * 8 / 9) * ra_sk1 * ra_sk2);
  document.ans.kikku_max.value = Math.round((ko_tr * 10 + ha_tr * 8 * 1.1) * ra_sk1 * ra_sk2);
  ...
  document.ans.yelhi.value = Math.round(hi_tr * 250 * hw_sk1 * hw_sk2 * Math.pow(1.04, go_item));
  document.ans.yelhi_min.value = Math.round(hi_tr * 250 * hw_sk1 * hw_sk2 * 0.9 * Math.pow(1.04, go_item));
  document.ans.yelhi_max.value = Math.round(hi_tr * 250 * hw_sk1 * hw_sk2 * 1.1 * Math.pow(1.04, go_item));
  document.ans.grehi.value = Math.round((hi_tr * 4 + ha_tr * 6) * 25 * hw_sk1 * hw_sk2 * Math.pow(1.04, go_item));
  document.ans.grehi_min.value = Math.round((hi_tr * 4 + ha_tr * 6) * 25 * hw_sk1 * hw_sk2 * 0.9 * Math.pow(1.04, go_item));
  document.ans.grehi_max.value = Math.round((hi_tr * 4 + ha_tr * 6) * 25 * hw_sk1 * hw_sk2 * 1.1 * Math.pow(1.04, go_item));
  document.ans.redhi.value = Math.round((hi_tr * 4 + ko_tr * 6) * 25 * hw_sk1 * hw_sk2 * Math.pow(1.04, go_item));
  document.ans.redhi_min.value = Math.round((hi_tr * 4 + ko_tr * 6) * 25 * hw_sk1 * hw_sk2 * 0.9 * Math.pow(1.04, go_item));
  document.ans.redhi_max.value = Math.round((hi_tr * 4 + ko_tr * 6) * 25 * hw_sk1 * hw_sk2 * 1.1 * Math.pow(1.04, go_item));
